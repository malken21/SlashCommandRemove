...
client.on("interactionCreate", interaction => {
  ...
  if (interaction.type == "APPLICATION_COMMAND") {
    client.application.commands.delete(interaction.commandId);//コマンド削除
  } else {
    client.guilds.cache.get(interaction.guildId).commands.delete(interaction.commandId);//ギルドコマンド削除
  }
});